...
const InfinitySymbol: React.FC<{ className?: string }> = ({ className }) => (
  <svg 
    viewBox="0 0 200 100" 
    className={`w-full max-w-[510px] h-auto text-white ${className}`}
    fill="none" 
 ...
 * the SVG's rendered height (it is 2:1, capped at 510px wide).
 */
const FIGURE_HALF = 'var(--infinity-h, min(255px, calc(42.5vw - 20px))) / 2';
